...
bool Rock::InitializeBuffers(){
	...
	vertices[0]._position = D3DXVECTOR3(-1.0f, -1.0f, 0.0f);  // Bottom left.
	vertices[0]._uv = D3DXVECTOR2(0.0f, 1.0f);

	vertices[1]._position = D3DXVECTOR3(0.0f, 1.0f, 0.0f);  // Top middle.
	vertices[1]._uv = D3DXVECTOR2(0.5f, 0.0f);

	vertices[2]._position = D3DXVECTOR3(1.0f, -1.0f, 0.0f);  // Bottom right.
	vertices[2]._uv = D3DXVECTOR2(1.0f, 1.0f);
