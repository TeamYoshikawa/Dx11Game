...
void CameraManager::Initialize()
{
	...
	m_camera->property._translation = m_propaty[m_cameraID].m_changeCameraTranslationArray;
	m_camera->property._rotation = m_propaty[m_cameraID].m_changeCameraRotationArray;
}
