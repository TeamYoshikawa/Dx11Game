...
bool SceneTitle::Initialize()
{
	...
	//窓側
	m_wall[1]->property._transform._translation = Vector3(14.0, 100, 9);
	...
	m_wall[5]->property._transform._translation = Vector3(400.0, 265, 11);
	m_wall[5]->property._transform._scale = Vector3(600, 300, 10);
	

	m_wall[4]->property._transform._translation = Vector3(400.0, -200, 12);
	...
	title->property._transform._rotation._y=180;
...
void SceneTitle::InitStage()
{
	...
	m_stage->LoadFBX("ModelData/models/Stage_door.fbx", eAxisSystem::eAxisOpenGL);
